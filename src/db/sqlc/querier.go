...
type Querier interface {
	...
	CreateOrderRecord(ctx context.Context, arg CreateOrderRecordParams) (OrderDetail, error)
	...
	GetOrderItemList(ctx context.Context, arg GetOrderItemListParams) ([]OrderItem, error)
	...
	GetUserOrderSummary(ctx context.Context, arg GetUserOrderSummaryParams) ([]GetUserOrderSummaryRow, error)
